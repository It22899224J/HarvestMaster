...
//Weather API invoke
    ...
    public CurrentWeather getCurrentWeather(String zip) {
        String url = "http://api.openweathermap.org/data/2.5/weather?zip="+zip+",lk&appid=ddb64a174007a68a4edc85f09f65f2e6&units=metric";
...
//Weather API invoke
        ...
        try {
            currentWeatherResponse = objectMapper.readValue(jsonString, CurrentWeather.class);
        } catch (JsonProcessingException e) {
            throw new RuntimeException(e);
        }
